...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_TIRE_DETECTION_RESPONDER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_TIRE_DETECTION_RESPONDER_H_
...
#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_TIRE_DETECTION_RESPONDER_H_
