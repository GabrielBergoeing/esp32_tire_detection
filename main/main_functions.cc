...
void setup() {
  ...
  model = tflite::GetModel(g_tire_model_data); //g_person_detect_model_data
...
void loop() {
  ...
  float full_tire_score_f =
      (full_tire_score - output->params.zero_point) * output->params.scale;
  float no_tire_score_f =
      (no_tire_score - output->params.zero_point) * output->params.scale;

  // Respond to detection
  RespondToDetection(flat_tire_score_f, full_tire_score_f, no_tire_score_f);
